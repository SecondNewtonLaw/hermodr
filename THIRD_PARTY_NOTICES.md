...
562 crates, mostly MIT or Apache-2.0. A few are MPL-2.0, which is
...
| buffa | 0.9.2 | Apache-2.0 |
| buffa-build | 0.9.2 | Apache-2.0 |
| buffa-codegen | 0.9.2 | Apache-2.0 |
| buffa-descriptor | 0.9.2 | Apache-2.0 |
...
| diesel | 2.3.13 | MIT OR Apache-2.0 |
| diesel_derives | 2.3.10 | MIT OR Apache-2.0 |
| diesel_migrations | 2.3.2 | MIT OR Apache-2.0 |
| diesel_table_macro_syntax | 0.3.0 | MIT OR Apache-2.0 |
...
| dsl_auto_type | 0.2.0 | MIT OR Apache-2.0 |
...
| memoffset | 0.9.1 | MIT |
| migrations_internals | 2.3.0 | MIT OR Apache-2.0 |
| migrations_macros | 2.3.0 | MIT OR Apache-2.0 |
...
| scheduled-thread-pool | 0.2.7 | MIT/Apache-2.0 |
| schemars | 0.8.22 | MIT |
| schemars | 0.9.0 | MIT |
| schemars | 1.2.2 | MIT |
...
| wacore | 0.7.0 | MIT |
| wacore-appstate | 0.7.0 | MIT |
| wacore-binary | 0.7.0 | MIT |
| wacore-derive | 0.7.0 | MIT |
| wacore-libsignal | 0.7.0 | MIT |
| wacore-noise | 0.7.0 | MIT |
...
| whatsapp-rust | 0.7.0 | MIT |
| whatsapp-rust-sqlite-storage | 0.7.0 | MIT |
| whatsapp-rust-tokio-transport | 0.7.0 | MIT |
...
| clsx | 2.1.1 | MIT |
| cookie | 0.6.0 | MIT |
| country-flag-emoji-polyfill | 0.1.10 | MIT |
| deepmerge | 4.3.1 | MIT |
| detect-libc | 2.1.2 | Apache-2.0 |
| devalue | 5.9.4 | MIT |
| emojibase | 17.0.0 | MIT |
